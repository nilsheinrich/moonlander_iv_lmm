...
# New variable - N frames steering while within drift section
```{r N_frames_steering_while_drift, include=FALSE}

soc_data$N_frames_steering <- soc_data$N_frames_input_in_drift / soc_data$N_drift

```
Explored how the steering within drift sections (in which steering has no effect) influences SoC responses. Found no effects and thus excluded this posthoc added variable from model selection again.
